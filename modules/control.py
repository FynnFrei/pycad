...
population_folder = 0       # folder is called 'population{population_folder}'
wood_type = 'EuropeanOak'
...
def test_code():
    ...
    number_of_couples = 7      # each couple has 2 children
    number_of_parents_to_keep = 0
    keep_best_parent = False
    mutation_probability = 0.05
    mutate_range_x, mutate_range_y = 10, 0.4
